...
observeEvent(input$slope, {
  updateSelectInput(session, input = "select_wells", label = NULL, 
                    choices = getWellList(input$slope[1], input$slope[2], 
                                          ...
                                          input$hpu, input$wellDepth), selected = NULL)})
...
getWellList <- function(minValSlope, maxValSlope, minValAsp, maxValAsp, hpuValsList, depthValsList) { 
