...
observeEvent(input$slope, {
  updateSelectInput(session, input = "select_wells", label = NULL, 
                    choices = getWellList(input$slope[1], input$slope[2], 
                                          ...
                                          input$hpu, input$wellDepth, input$twi[1], input$twi[2], input$uaa[1], input$uaa[2]), selected = NULL)})
...
getWellList <- function(minValSlope, maxValSlope, minValAsp, maxValAsp, hpuValsList, depthValsList, minTwi, maxTwi, minUaa, maxUaa) { 
