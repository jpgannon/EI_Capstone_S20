...
observeEvent(input$slope, {
  updateSelectInput(session, input = "select_wells", label = NULL, 
                    choices = getWellList(input$slope[1], input$slope[2], 
                                          ...
                                          input$hpu, input$wellDepth, input$twi[1], input$twi[2]), selected = NULL)})
...
observeEvent(input$hpu, {
  updateSelectInput(session, input = "select_wells", label = NULL, 
                    choices = getWellList(input$slope[1], input$slope[2], 
                                          input$aspect[1], input$aspect[2], 
                                          input$hpu, input$wellDepth, input$twi[1], input$twi[2]))})
...
getWellList <- function(minValSlope, maxValSlope, minValAsp, maxValAsp, hpuValsList, depthValsList, minTwi, maxTwi) { 
