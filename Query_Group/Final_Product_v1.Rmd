...
Date Range - used to select a date range in which to view the filtered wells. This can be changed by clicking the date, then picking a new year, month, and specific date. <br>
...
<em> If there is currently no wells selected and the download button is pressed, then the csv file will be empty. </em> <br>
<p>
