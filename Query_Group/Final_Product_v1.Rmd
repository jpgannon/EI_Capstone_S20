...
sliderInput("slope", "Slope Range:", min = 3, max = 29,
            value = c(3, 29), ticks = TRUE, dragRange = TRUE)

# make a slider widget for aspect
sliderInput("aspect", "Aspect Range:", min = 0, max = 360,
...
sliderInput('distStream', "Distance to Stream Range:", min = 0, max = 83, 
...
Application authors: [Sean Calida](https://www.linkedin.com/in/sean-calida/),
[Erica Schermerhorn](), 
[Eric Rosenthal](),
[Katie Dunlap](), [Ian Bogucki](),
[Virginia Tech University](https://cnre.vt.edu/)
