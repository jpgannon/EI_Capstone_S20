...
well_vals <- reactiveValues(
  ...
  twi = c(5.091865, 13.30638), uaa = c(0, 0.631029), hpu = unique(hpu_data$HPU),
...
sliderInput("uaa", "Select a UAA range", min = 0, max = 0.631029, 
            value = c( 0, 0.631029), ticks = TRUE, dragRange = TRUE)

# make a slider input for TWI
sliderInput("twi", "Select a TWI range", min = 5.091865, max = 13.30638, 
            value = c(5.091865, 13.30638), ticks = TRUE, dragRange = TRUE)
