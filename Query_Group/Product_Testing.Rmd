...
```{r}
ranges <- reactiveValues(x = as.Date(c(start = "2010-07-01", 
                                       end = "2018-01-01")))
maxrange <- reactiveValues(x = as.Date(c(start = "2010-07-01", 
                                         end = "2018-01-01")))
...
renderPlot({
  ...
  ggplot(data = selected_data, mapping = aes(x = date, y = level)) +
    ...
    coord_cartesian(xlim = c(as.Date(input$date_range[1]), 
