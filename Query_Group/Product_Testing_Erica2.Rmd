...
observeEvent(input$selectAllWellsBox, 
             {updateSelectInput(session, 
                                input = "select_wells", 
                                label = NULL, 
                                #choices = getWellList(input$slope[1], input$slope[2],input$aspect[1], input$aspect[2]), 
                                selected =if(input$selectAllWellsBox == TRUE){getWellList(input$slope[1], input$slope[2],input$aspect[1], input$aspect[2])}else{NULL})})
