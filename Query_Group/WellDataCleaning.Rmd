...
```{r}
allHPUdataRaw <- read_csv("C:/Users/scint/OneDrive/Documents/VT/Spring 2020/capstone/legacyDataNoNotes.csv")
allHPUDataClean <- allHPUdataRaw %>% select(c(Well, HPU)) %>% na.omit()
